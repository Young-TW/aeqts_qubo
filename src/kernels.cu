...
__global__ void generate_neighbours_kernel(
    ...
    unsigned char* __restrict__ neighbours, int N, int n_items,
...
__global__ void updateQ_kernel(const unsigned char* __restrict__ neighbours,
                               const int* __restrict__ sorted_idx,
                               float* __restrict__ q_alpha,
                               float* __restrict__ q_beta, int N, int n_items) {
